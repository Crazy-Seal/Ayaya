...
from app.agent_v2.context import (
    ToolContext,
    ToolResult,
    PluginHook,
)
from app.agent_v2.core.event_router import EventType, AgentEvent
from app.agent_v2.message import (
    ToolCall,
    Message,
    ContentPart,
    MessageRole,
...
class ExecutionPipeline:
    ...
    def _append_tool_result(
        ...
        if result.image_url:
            # 取代旧的 ScreenshotNode：图片以 user 消息进入，工具槽位只留文本
