...
from app.agent_v2.utils.infra.constants import VLM_DEFAULT_MODEL, VLM_DEFAULT_BASE_URL
from app.agent_v2.utils.domain.images import ImageTaskResult, save_multiple_images
