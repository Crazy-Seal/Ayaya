...
from app.agent_v2.message import Message, ContentPart
from app.agent_v2.context import BaseTool, BasePlugin, InterruptEvent
from app.agent_v2.core.tool_manager import ToolManager
from app.agent_v2.core.plugin_manager import PluginManager
...
class Agent:
    ...
    async def _setup_plugins(self) -> None:
        """根据配置加载插件"""
        # 从插件注册表加载
        from app.agent_v2.plugins.registry import PluginRegistry
    ...
    async def _setup_mcp(self) -> None:
        ...
        from app.agent_v2.mcp.plugin import MCPPlugin
